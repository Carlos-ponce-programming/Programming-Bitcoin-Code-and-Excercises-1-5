...
class PointTest(TestCase):
    ...
    def test_add(self):
        ...
        p1 = Point(x1, y1, a, b)
        p2 = Point(x2, y2, a, b)
        p3 = Point(FieldElement(220, prime), FieldElement(181, prime), a, b)
        
        x4 = FieldElement(47, prime)
        y4 = FieldElement(71, prime)
        x5 = FieldElement(17, prime)
        y5 = FieldElement(56, prime)
        p4 = Point(x1, y1, a, b)
        p5 = Point(x2, y2, a, b)
        p6 = Point(FieldElement(215, prime), FieldElement(68, prime), a, b)
        
        x7 = FieldElement(143, prime)
        y7 = FieldElement(98, prime)
        x8 = FieldElement(76, prime)
        y8 = FieldElement(66, prime)
        p7 = Point(x1, y1, a, b)
        p8 = Point(x2, y2, a, b)
        p9 = Point(FieldElement(47, prime), FieldElement(71, prime), a, b)
        
        self.assertEqual(p1 + p2, p3)
        self.assertEqual(p4 + p5, p6)
        self.assertEqual(p7 + p8, p9)
...
class ECCTest(TestCase):
    ...
    def test_add(self):
        ...
        # initialize x's and y's as FieldElements
            x1FE = FieldElement(x1, prime)
            y1FE = FieldElement(y1, prime)
            x2FE = FieldElement(x2, prime)
            y2FE = FieldElement(y2, prime)
            x3FE = FieldElement(x3, prime)
            y3FE = FieldElement(y3, prime)
        # create p1, p2 and p3 as Points
            p1 = Point(x1FE, y1FE, a, b)
            p2 = Point(x2FE, y2FE, a, b)
            p3 = Point(x3FE, y3FE, a, b)
        # check p1+p2==p3
            self.assertEqual(p1 + p2, p3)
